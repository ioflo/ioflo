...
class BasicTestCase(unittest.TestCase):
    ...
    def testNonBlockingRequestStreamChunked(self):
        ...
        #msgOut = b'HTTP/1.1 200 OK\r\nContent-Type: text/event-stream\r\nCache-Control: no-cache\r\nTransfer-Encoding: chunked\r\nDate: Thu, 30 Apr 2015 20:11:35 GMT\r\nServer: IoBook.local\r\n\r\nd\r\nretry: 1000\n\n\r\nd\r\ndata: START\n\n\r\n9\r\ndata: 1\n\n\r\n\nRX ('127.0.0.1', 8080)\n9\r\ndata: 2\n\n\r\n\nRX ('127.0.0.1', 8080)\n9\r\ndata: 3\n\n\r\n\nRX ('127.0.0.1', 8080)\n9\r\ndata: 4\n\n\r\n\n'
        msgOut = b''.join(lines)
        ixBeta.transmit(msgOut)
        while ixBeta.txes or not beta.rxbs:
            alpha.serviceTxesAllIx()
    ...
    def testNonBlockingRequestStreamOld(self):
        """
        Test NonBlocking Http client
        """
        console.terse("{0}\n".format(self.testNonBlockingRequestStreamOld.__doc__))
...
if __name__ == '__main__' and __package__ is None:
    ...
    runOne('testNonBlockingRequestStreamChunked')
